                    ...
                    <div class="user-dashboard-sidebar">
                        ...
                        <div class="user-dashboard-menu">
                            <ul>
                                ...
                                <li><a href="http://localhost/daily_progress.html">Mark My Progress</a></li>
                                <li><a href="http://localhost/Online_Learning_Management_System/bot.php?">ChatBot Assistance</a></li>
                            </ul>
                        </div>
                    </div>
